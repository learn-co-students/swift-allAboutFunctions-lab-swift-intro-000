...
func twoArguments(bandName:String,number:Int) {
    print("My #\(number) favorite band is \(bandName)")
}
 twoArguments(bandName: "U2", number: 1)
...
madLib(name: "Ted", noun: "Space", preposition: "Beyond")
...
func returnName(name:String) -> String {
    ...
    let returnMessage = ("To infinity and beyond, \(name.uppercased())!")
    
    return returnMessage
    
}

var note = returnName(name: "goofy")
print(note)
note = returnName(name: "spidy")
print(note)
