 ...
 */
func solvedProblems (number: Int) {

    print("I got \(number) problems but Swift ain't one")

}

solvedProblems(number: 5)
 ...
 */
func myFavoriteBand (number: Int, name: String) {
    
    print("My #\(number) favorite band is \(name).")
    
}

myFavoriteBand(number: 1, name: "Metallica")
...
madLib(characterName: "Maksim", noun: "smartphone", preposition: "behind")
...
print(charactersName(name: "maksim"))
