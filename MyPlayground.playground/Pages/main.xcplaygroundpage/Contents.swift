 ...
 */
func anotherFunc(bandName: String, number: Int) {
...
madLib("Dog", noun: "Cat", prep: "Booty")
 ...
 */
func soFuncyOMG(name: String) -> String{
    return "To infinity and beyond \(name.uppercaseString)!"
}
print(soFuncyOMG("Big Boy"))
