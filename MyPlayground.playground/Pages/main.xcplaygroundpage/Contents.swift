...
favCharacter(characterName: "Bella")
/*: question4
 ### 4. Call the function you wrote in Question 3 using a constant you define. Then call it using a variable. Change the value of the variable, and call it again. What do you see in the console?
 */
// write your code here
let characterName = "John"
favCharacter(characterName: characterName)
/*: question5
 ### 5. Write a function that takes an integer as an argument and prints the string "I got <number> problems but Swift ain't one" to the console.
 */
// write your code here
func numberProblems(number:Int){
    print("I got \(number) problems but Swift ain't one")
}

numberProblems(number: 10)
numberProblems(number: 11)
/*: question6
...
band(bandName: "Beettles", number: 10)
/*: question7
...
madLib(characterName: "noun", noun: "preposition", preposition: "character")
/*: question10
 ...
 */
// write your code here
func charName(char:String)->String{
