 ...
 */
func favoriteCharacter (charName : String){
    
    print("My favorite character is \(charName)")
}
favoriteCharacter(charName: "Jery")
...
favoriteCharacter(charName: myFavCharacter)
var anotherCharacter = "Luke Skywalker"
favoriteCharacter(charName: anotherCharacter)
...
favoriteBand(band: "Guns 'n Roses", number: 1)
...
madLib(charName: "Jery", noun: "tree", preposition: "on")
 ...
 */
func infinityAndBeyond (charName: String) -> String {
    
    return "To infinity and beyond, \(charName)!"
}
print(infinityAndBeyond(charName: "Woody"))
