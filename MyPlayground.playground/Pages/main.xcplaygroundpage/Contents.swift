 ...
 */
let secondCharacter = "Vegeta"
characterName(name:secondCharacter)
var thirdCharacter = "Gohan"
characterName(name: thirdCharacter)
thirdCharacter = "Freeza"
characterName(name:thirdCharacter)
...
favoriteBand(name:"The Beatles", number:1)
...
madLib(characterName: "Goku", noun: "place", preposition: "apart")
...
func character(name:String)-> String
{
	...
	return "To inifity and beyond, \(name.uppercased())"
}
print(character(name:"Buzz Lightyear"))
