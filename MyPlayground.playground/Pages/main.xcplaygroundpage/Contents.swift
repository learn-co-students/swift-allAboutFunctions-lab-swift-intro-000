...
favoriteCharacter(name: "Lebowski")
 ...
 */
let characterName: String = "Lebowski"

favoriteCharacter(name: characterName)

var characterName2: String = "Buckaroo Bonzai"

favoriteCharacter(name: characterName2)

characterName2 = "spider-man"
...
favoriteBand(bandname: "GnR", number: 1)
...
madLib(characterName: "Popeye", noun: "spinach", preposition: "in")
 ...
 */
func goodStuff(name: String) -> String{
    let uppercaseName = name.uppercased()
    return "To infinity and beyond, \(uppercaseName)"
}

print(goodStuff(name: "larry"))
