 ...
 */
func fooBaz(name: String, number: Int) {
 ...
 */
func madLib(_ name: String, _ noun: String, _ proposition: String) {
    print("To \(noun) and \(proposition), \(name)!")
}
