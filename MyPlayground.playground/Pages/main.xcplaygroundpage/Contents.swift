 ...
 */
let constant = "Woody"
favCharacter(name: constant)

var variable = "Buzz"
favCharacter(name: variable)
variable = "Slinky"
favCharacter(name: variable)
...
madLib(character: "Elsa", noun: "space", preposition: "around")
 ...
 */
func buzzCatchphrase(character: String) -> String {
    return "To infinity and beyond, \(character)!"
}

buzzCatchphrase(character: "Andy")
