...
madLib(character: "Barney", noun: "President", preposition: "For")
 ...
 */
// write your code here
func lastOne(character: String) -> String{
    return "To infinity and beyond, \(character.uppercased())!"
}

print(lastOne(character: "Woody"))
