 ...
 */
var myFavcharacter = "Anna"
favCharacter(character: myFavcharacter)
myFavcharacter = "Elsa"
favCharacter(character: myFavcharacter)
 ...
 */
func myProblem(numOfProblem: Int) {
    print("I got \(numOfProblem) problems but Swift ain't one")
}
 ...
 */
func myFavBand(band: String, ranking: Int) {
