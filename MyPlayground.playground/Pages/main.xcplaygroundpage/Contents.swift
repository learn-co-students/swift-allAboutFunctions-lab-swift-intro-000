 ...
 */
// write your code here
func takeName(character:String){
...
let myChar = takeName(character: "batman")
 ...
 */
// write your code here
func takeTwoArgs(number:Int,name:String){
...
madLib(charName: "Spiderman", noun: "jump", preposition: "at")
...
func returnUppercase(character:String) ->String{
    return "To infinity and beyond, \(character.uppercased())!"
}

returnUppercase(character: "othman")
