...
exercise3(name: "Harry")
exercise3(name: "Leila")
 ...
 */
// write your code here
func exercise6(bandName: String, number: Int){
    print("My \(number) favorite band is \(bandName)")
}

exercise6(bandName: "Muse", number: 1)
...
madLib(characterName: "Leila", noun: "table", preposition: "under")
 ...
 */
// write your code here
func exercise12(characterName: String) -> String {
    return "To infinity and beyond, \(characterName.uppercased())!"
}

exercise12(characterName: "Harry")
