...
printChar(name: "Superman")
printChar(name: charName)
 ...
 */
// write your code here
func numBand(band: String, rank: Int){
 ...
 */
// write your code here
func returnCharName(character: String) -> String{
