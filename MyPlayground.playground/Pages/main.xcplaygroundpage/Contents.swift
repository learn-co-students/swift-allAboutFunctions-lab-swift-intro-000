...
func problems(many: Int) {
   print("I got \(many) problems but Swift ain't one")
}
...
func madLibs(noun: String, prep: String, charName: String) {
    print("To \(noun) and \(prep), \(charName)")
}

madLibs(noun: "ball", prep: "between", charName: "donald")
