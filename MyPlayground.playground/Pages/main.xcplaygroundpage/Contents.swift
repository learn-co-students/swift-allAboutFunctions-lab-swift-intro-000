 ...
 */
let character1 = "Steve Holt"
printCharacter(name: character1)
var character2 = "Pikachu"
printCharacter(name: character2)
 ...
 */
func printFavorite(band: String, number: Int) {
...
madLib(character: "Steve", noun: "cat", preposition: "with")
 ...
 */
func uppercaseInfinity(character: String) -> String {
