...
let bestCharacter = "Superman"
character(name: bestCharacter)
 ...
 */
func bestBand(band: String, num: Int){
    print("My #\(num) favorite band is \(band).")
}

bestBand(band: "Nirvana", num: 3)
/*: question7
...
madLib(name: "Mere", noun: "infinity", preposition: "beyond")
 ...
 */
func toInfinity(cName: String) -> String {
    return "To infinity and beyond, \(cName)"
}

toInfinity(cName: "Ronan")
