...
let myFirstConstant = "X"
someFunction(name: myFirstConstant)
var anotherConstant = "Y"
someFunction(name: anotherConstant)
anotherConstant = "Z"
someFunction(name: anotherConstant)
...
func charNeme(name: Character) -> String {
