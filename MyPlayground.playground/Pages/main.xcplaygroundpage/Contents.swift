...
func bandFaves(name: String, num: Int) {
    
    print("My #\(num) favorite band is \(name).")
    
}
bandFaves(name: "Eagles", num: 4)
...
func example3(name: String) -> String {
    return "To infinity and beyond, \(name.uppercased())"
}
print(example3(name: "Woody"))
