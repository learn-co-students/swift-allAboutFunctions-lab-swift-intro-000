 ...
 */
func func3(name: String, number: Int)
{
    print("My #\(number) favorite band is \(name)")
}

func3(name: "Panic!", number: 1)
 ...
 */
func func4(name: String, noun: String, prep: String)
{
    print("To \(noun) and \(prep), \(name)!")
}

func4(name: "Max", noun: "Bird", prep: "In")
