 ...
 */
// write your code here
let charName = "Jon Snow"
var charName2 = "Tywin"

faveChar(name: charName)
faveChar(name: charName2)
...
func faveBand (bandName: String, bandNumber: Int) {
    print("My #\(bandNumber) favorite band is \(bandName).")
}

faveBand(bandName: "Arctic Monkeys", bandNumber: 1)
