 ...
 */
func character(charName: String) {
    print("My favorite character is \(charName).")
}
character(charName: "Winnie the pooh")
 ...
 */
func myBand(band: String, rank: Int) {
    print("My #\(rank) favorite band is \(band).")
}
myBand(band: "Nirvana", rank: 1)
/*: question7
...
madLib(charName: "Justin ", noun: "infinity", prep: "beyond")
/*: question10
