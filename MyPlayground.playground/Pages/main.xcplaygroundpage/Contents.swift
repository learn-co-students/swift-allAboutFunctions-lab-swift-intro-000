...
test1(name: firstName)

/*: question5
 ### 5. Write a function that takes an integer as an argument and prints the string "I got <number> problems but Swift ain't one" to the console.
 */
// write your code here
func test2(number: Int) {
...
test3(name: "The Beatles", number: 1)
 ...
 */
// write your code here
func test4(character: String, noun: String, preposition: String) {
    print("To \(noun) and \(preposition), \(character)!")
}

test4(character: "Batman", noun: "Kuching", preposition: "fast")
