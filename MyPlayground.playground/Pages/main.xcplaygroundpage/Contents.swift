 ...
 */
func favorite(character: String) {
 ...
 */
let favoriteCharacter = "Olaf"
favorite(character: favoriteCharacter)

var otherFavoriteCharacter = "Anna"
favorite(character: otherFavoriteCharacter)

otherFavoriteCharacter = "Shrek"
favorite(character: otherFavoriteCharacter)
 ...
 */
func rankFavorite(band: String, rank: Int) {
    print("My #\(rank) favorite band is \(band)")
}

rankFavorite(band: "Pink Floyd", rank: 1)
...
madLib(characterName: "Charlie", noun: "Spagetti", preposition: "after")
 ...
 */
func catchPhrase(characterName: String) -> String {
    return "To infinity and beyond, \(characterName)"
}

catchPhrase(characterName: "Woody")
