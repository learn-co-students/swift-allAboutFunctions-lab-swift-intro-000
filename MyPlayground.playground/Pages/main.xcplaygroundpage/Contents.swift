 ...
 */
let favechar = favoriteCharacter(name: "Elsa")
favechar
var favoritechar = favoriteCharacter(name: "Elsa")
 ...
 */
func someProblems(problems: Int) {
    print("I got \(problems) problems but Swift ain't one.")
}
someProblems(problems: 16)
...
favoriteBand(bandName: "Darlingside", number: 6)
...
madLib(characterName: "Elsa", noun: "book", preposition: "around")
 ...
 */
func foreverCharacter(name: String) {
name.uppercased()
let uppercasedName = name.uppercased()
print("To infinity and beyond, \(uppercasedName)!")
}
foreverCharacter(name: "buzz")
