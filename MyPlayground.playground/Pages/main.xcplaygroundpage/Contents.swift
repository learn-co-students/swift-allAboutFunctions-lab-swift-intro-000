 ...
 */
// write your code here
func twoArgs(name: String, num: Int){
    print("My #\(num) favorite band is \(name)")
}
twoArgs(name: "BuzzBand", num: 2)
...
madLib(name: "Prince", noun: "Palace", preposition: "What")
