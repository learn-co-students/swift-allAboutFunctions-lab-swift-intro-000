...
madLib(name: "David", noun: "Hollywood", preposition: "through")
 ...
 */
func charName(charsName: String) -> String {
    return "To infinity and beyond, \(charsName.uppercased())!"
}
