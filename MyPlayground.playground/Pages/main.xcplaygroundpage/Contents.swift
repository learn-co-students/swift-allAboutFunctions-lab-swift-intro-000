...
let friend = (favoriteCharacter("John"))


var favChar = (favoriteCharacter("Jim"))
...
func band(number: Int, name: String) {
    print("My #\(number) favorite band is \(name)")
}

band(1, name: "Coldplay")
...
madLib("John", noun: "apples", preposition: "to")
