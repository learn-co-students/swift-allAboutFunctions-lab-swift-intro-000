 ...
 */
let cons = "Sherlock Holmes"
favChar(name: cons)

var notCons = "Mickey Mouse"
favChar(name: notCons)

notCons = "Forrest Gump"
favChar(name: notCons)
...
madLib(name: "Abby", noun: "watermelon", preposition: "beyond")
