 ...
 */
let myFavCharacter = "Bambi"
favoriteCharacter(myFavCharacter)
var anotherCharacter = "Darth Vader"
favoriteCharacter(anotherCharacter)
anotherCharacter = "Frodo"
favoriteCharacter(anotherCharacter)
 ...
 */
func noProblems(_ numberOfProblems: Int) {
 ...
 */
func favBand(_ band: String, _ number: Int) {
    
    print("My #\(number) favorite band is \(band)")
    
}

favBand("Okean Elzy", 1)
...
madLibs(characterName: "Michael Jordan", noun: "basketball", preposition: "on")
...
print(characterName(name: "Gilbert"))
