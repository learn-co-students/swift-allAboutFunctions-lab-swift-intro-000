 ...
 */
let name1 = "Larry"
favChar(charName: name1)
var name2 = "Curly"
favChar(charName: name2)
name2 = "Moe"
favChar(charName: name2)
 ...
 */
func cheesy(i: Int) {
    print("I got \(i) problems but Swift aint't one")
}
 ...
 */
func favBand (bandName: String, num: Int) {
...
madLib(charName: "Woody", noun: "Hat", preposition: "after")
