...
let c1 = "Zhou Yu"
var c2 = "Zhuge Liang"
FavCharacter(name: c1)
FavCharacter(name: c2)
c2 = "Ye Wen"
FavCharacter(name: c2)
 ...
 */
// write your code here
func myFavBand (band: String, num: Int) {
    print("My #\(num) favorite band is \(band)")
}

myFavBand(band: "Black", num: 2)
...
madLib(name: "Jack", noun: "Apple", preposition: "Taste")
 ...
 */
// write your code here
func toast (name: String) -> String {
    return "To infinity and beyond, \(name.uppercased())"
}

print(toast(name: "Jon Snow"))
