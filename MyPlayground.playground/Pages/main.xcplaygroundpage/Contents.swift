...
favoriteCharacter(name: "Spiderman")
 ...
 */
let myFavoriteCharacter = "Batman"
favoriteCharacter(name: myFavoriteCharacter)
var anotherCharacter = "Wolverine"
 ...
 */
func favoriteBand(number: Int, name: String) {
    print("My #\(number) favorite band is \(name).")
}
favoriteBand(number: 1, name: "ACDC")
...
badFavoriteBand(bandName: "The Beatles", position: 1)
...
madLib(name: "Buzz", noun: "infinity", preposition: "beyond")
