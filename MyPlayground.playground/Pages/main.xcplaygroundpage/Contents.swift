...
faveCharacter(name: bro)
faveCharacter(name: what)
...
faveBand(name: "Bon Jovi", number: 1254)
...
madLib(name: "Jeffrey", noun: "the doctor's office", preposition: "fast")
...
let character = charName(name: "Woody")
print(character)
