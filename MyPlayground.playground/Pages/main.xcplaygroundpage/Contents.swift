 ...
 */
let myFavoriteCharacter = "The Dude"
favoriteCharacter(myFavoriteCharacter)
var anotherCharacter = "Donny"
favoriteCharacter(anotherCharacter)
anotherCharacter = "The Big Lebowski"
favoriteCharacter(anotherCharacter)
 ...
 */
func iGotProblems( _ problems: Int){
 ...
 */
func favoriteBand( _ band: String, _ position: Int) {
    print("My # \(position) favorite band is \(band).")
}

favoriteBand("The Clash", 1)
...
madLib(characterName: "Donald", noun: "house", preposition: "go")
