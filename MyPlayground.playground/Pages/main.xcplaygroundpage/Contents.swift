 ...
 */
func favChar(_ charName: String) {
 ...
 */
func favBand(bandName name: String, number num: Int) {
    print("My #\(num) favorite band is \(name)")
}
favBand(bandName: "Coldplay", number: 1)
...
madLib(charName: "Woody", noun: "sdj", preposition: "dsjf")
...
func returnString() -> String {
    var sentence = "Buzz Lightyear to the rescue!"
    return sentence
}
var a = returnString()
