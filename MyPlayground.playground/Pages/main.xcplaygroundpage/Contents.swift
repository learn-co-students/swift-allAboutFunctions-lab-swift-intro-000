 ...
 */
func Disney(toon: String){
    print("My favorite character is \(toon)")
}
 ...
 */
let disneyToon = "Trish"

Disney(toon: disneyToon)
...
madLib(name: "Buzz", noun: "infinity", prep: "beyond")
 ...
 */
func finalone(name: String) -> String{
