 ...
 */
// write your code here
func printBank(band: String, num: Int){
...
madLib(name: "Zhe", noun: "Help", preposition: "Ah")
 ...
 */
// write your code here
func printCharName(name: String)->String{
    return "To infinity and beyond, \(name)!"
}
print(printCharName(name: "Zhe"))
