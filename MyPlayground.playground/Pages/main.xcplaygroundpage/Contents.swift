...
var charName = "RAME"
favoriteCharacter(name: charName)
charName = "BDE"
favoriteCharacter(name: charName)
...
madLib(name: "Linda", noun: "Burger", preposition: "for")
