...
madLib(name: "Caesar", noun: "man", prep: "under")
 ...
 */
func toyStoryMotto(character: String) -> String {
    return "To infinity and beyond, \(character.uppercased())"
}

toyStoryMotto(character: "Buz")
