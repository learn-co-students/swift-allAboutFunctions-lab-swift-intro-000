 ...
 */
let favChar = "Cinderella";
favCharacter(character: favChar);
var fav = "Smurfette";
favCharacter(character: fav);
fav = "Snow White";
favCharacter(character: fav);
 ...
 */
func bandInfo(band: String, num: Int) {
...
madLib(character: "Smurfette", noun: "smurf", prep: "into")
 ...
 */
func processCharacter(character: String) -> String {
