 ...
 */
let myFav = "Batman"
favCharacter(character: myFav)
var anotherFav = "Foo"
favCharacter(character: anotherFav)
anotherFav = "Bar"
favCharacter(character: anotherFav)
 ...
 */
func favBand(ord: Int, is name: String) {
    print("My \(ord) favorite band is \(name)")
}
favBand(ord: 1, is: "the band")
...
madLib(name: "Shake Shack", noun: "fork", preposition: "with")
