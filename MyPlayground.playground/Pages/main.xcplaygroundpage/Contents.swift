 ...
 */
let favCharacter = "Tyrion Lanister"
printFavCharacter(name: favCharacter)
favCharacter = "Jon Snow"
printFavCharacter(name: favCharacter)
// doesn't compile due to error, can't redeclare a constant after declaration
 ...
 */
func printProblems(_ numProblems: Int){
...
madLib("Rickson Gracie", "warriors", "all wannabe MMa fighters, mimmick ")
 ...
 */
func getSlogan(_ name: String) -> String {
