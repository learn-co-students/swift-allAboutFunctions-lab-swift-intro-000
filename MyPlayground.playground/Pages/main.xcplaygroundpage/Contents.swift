...
func problems(_ problemNum: Int) {
    print("I got \(problemNum) problems but Swift ain't one")
}
...
favBand("Dave Holland Quintet", 5)
...
func stuff(_ name: String) -> String {
