...
let neverChanging = "Morpheus"

favoriteChar(name: neverChanging)

var notSure = "The Dude"

favoriteChar(name: notSure)
notSure = "Donny"
...
func bandList(name: String, number: Int) {
