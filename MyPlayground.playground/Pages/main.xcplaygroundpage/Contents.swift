 ...
 */
let pressSecretary: String = "CJ Cregg"
favoriteCharacter(characterName: pressSecretary)
var president: String = "Bartlet"
favoriteCharacter(characterName: president)
president = "Santos"
favoriteCharacter(characterName: president)
 ...
 */
func problems(numProblems: String) {
 ...
 */
func bandInfo(bandName: String, ranking: Int) {
