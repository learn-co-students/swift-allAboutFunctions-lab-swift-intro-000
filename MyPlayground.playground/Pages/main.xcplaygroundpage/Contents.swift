...
// write your code here
let newName = "Dylfoot"
charName(name: newName)
var newerName = "Brian"
charName(name: newerName)
newerName = "Flip"
charName(name: newerName)
 ...
 */
// write your code here
func problemo(problems: Int){
    print("I got \(problems) problems but Swfit ain't one")
}

problemo(problems: 99)
...
madLib(characterName: "Bobby", noun: "Guitar", preposition: "about")
