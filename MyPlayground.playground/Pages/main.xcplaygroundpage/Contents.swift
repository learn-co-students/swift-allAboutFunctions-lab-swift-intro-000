 ...
 */
// write your code here
let myFav = "Mickey Mouse"

charName(name: myFav)
var myFav2 = "Might Mouse"
charName(name: myFav2)
...
// write your code here
func myFunc(arg: Int) {
    print("I got \(arg) problems, but Swift isn't one of them")
}
...
madLibs(name: "Mickey", noun: "car", preposition: "before")
 ...
 */
// write your code here
func toInfinityAndBeyond(name: String) -> String {
