 ...
 */
func six(band: String, numb: Int) {
    print("My #\(numb) favorite band is \(band).")
}

six(band: "The Lumineers", numb: 1)
...
madLib(name: "TJ Schoost", noun: "Feet", prep: "duh")
...
func twelve(name: String) -> String {
    ...
    let phrase = "To infinity and beyond, \(newName)!"
    return phrase
}
