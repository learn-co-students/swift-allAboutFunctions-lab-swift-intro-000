...
favoriteBand(bandName: "Linkin Park", number: 1)
...
madLib(name: "Paul", noun: "infinity", preposition: "beyond")
...
func buzzToTheRescue() -> String {
    let tagline = "Buzz Lightyear to the rescue!"
    return tagline
}
...
func toyStoryQuote(name: String) -> String {
    let quoteString = "To infinity and beyond, \(name.uppercased())!"
    return quoteString
}

toyStoryQuote(name: "Paul")
