...
var character = "Princess Leia"
starWars(name: character)
character = "Luke"
starWars(name: character)
...
madLib(character: "BB8", noun: "dog", preposition: "over")
...
infinity(character: "Princess Elsa")
