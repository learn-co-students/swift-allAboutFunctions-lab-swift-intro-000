 ...
 */
var myFavoriteCharacter = "Mickey Mouse"

favChar(character: myFavoriteCharacter)

myFavoriteCharacter = "Goofy"
 ...
 */
func nthFaveBand(number: Int, band: String){
 ...
 */
func myFunc2(character: String) -> String {
    var character = character.uppercased()
