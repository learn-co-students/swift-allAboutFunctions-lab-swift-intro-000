 ...
 */
// write your code here
func printLetItGoWithConst() {
    let statement = "Let it go!"
    print(statement)
}
 ...
 */
// write your code here
let myCharacter = "Darth Vader"
printCharacterName(name: myCharacter)
...
func bandName(name: String, number: Int) {
...
madLibs(name: "Chuck", noun: "dog", preposition: "his")
