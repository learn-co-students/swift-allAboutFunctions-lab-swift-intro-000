 ...
 */
func favBand(_ name: String, _ number: Int) {
 ...
 */
func whoYaGonnaCall() -> String {
    return "Buzz Lightyear to the rescue!"
}
print(whoYaGonnaCall())
 ...
 */
func buzz(_ name: String) -> String {
