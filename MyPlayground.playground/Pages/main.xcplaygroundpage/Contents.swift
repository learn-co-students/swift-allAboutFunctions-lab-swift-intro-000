...
favoriteCharacter(name: "Jon Snow")

/*: question4
 ### 4. Call the function you wrote in Question 3 using a constant you define. Then call it using a variable. Change the value of the variable, and call it again. What do you see in the console?
 */
let myFavCharacter = "Arya Stark"
favoriteCharacter(name: myFavCharacter)
var anotherCharacter = "Sansa Stark"
...
let favoriteBand = "Angels & Airwaves"
let spot = 1


favBand(name: favoriteBand, number: spot)

/*: question7
 ### 7. The code below is broken. Can you identify which line has an error and fix it so that it works again? Uncomment the code below before starting.
 */
func badFavoriteBand(bandName: String, position: Int) {    print("My #\(position) favorite band is \(bandName).")
}
...
madLib(name: name1, noun: noun1, preposition: prep1)
 ...
 */
func toInfinity(name: String){
    print("To infinity and beyond, \(name)")
}

let charName = "Kirstin"
charName.uppercased()

toInfinity(name: charName.uppercased())
