...
func yo(_ nb: Int)
{
    print ("I got \(nb) problems but Swift ain't one")
}
 ...
 */
func favBand(band:String, _ nb:Int)
{
    print("My #\(nb) favorite band is \(band)")
}

favBand(band:"Maroon5", 1)
