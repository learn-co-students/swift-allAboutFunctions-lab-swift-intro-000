...
favoriteCharacter(character: "Squirtle")
...
favoriteCharacter(character: starWars)

var pokemon = "Squirtle"

favoriteCharacter(character: pokemon)
 ...
 */
func bandRanking(bandName: String, bandPreference: Int)
{
    print("My #\(bandPreference) favorite band is \(bandName).")
}

bandRanking(bandName: "Death Cab for Cutie", bandPreference: 1)
...
madLib(characterName: "Fred", noun: "beach", preposition: "about")
