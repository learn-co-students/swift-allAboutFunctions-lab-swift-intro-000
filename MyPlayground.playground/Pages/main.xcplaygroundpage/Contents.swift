 ...
 */
func problems(numberproblems: Int) {
    print ("I got \(numberproblems) problems but Swift ain't one")
}
problems(numberproblems: 10)
 ...
 */
func namethecharacter(cName: String) {
    print("To infinity and beyond, \(cName)!.")
}

namethecharacter(cName: "UncleSam")
