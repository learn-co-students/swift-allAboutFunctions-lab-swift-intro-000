...
favoriteCharacter(name: "Bruce Springfield")
 ...
 */
func problems(number numberOfProblems: Int) {
 ...
 */
func favoriteBand(is band: String, atNumber number: Int) {
  print("My #\(number) favorite band is \(band).")
}

favoriteBand(is: "Creedence Clearwater Revival", atNumber: 1)
...
madLib(name: "Harry", noun: "Oops", preposition: "don't know")
