...
favoriteCharacter(character: "Anna")
 ...
 */
let mostFavoriteCharacter = "Anna"

favoriteCharacter(character: mostFavoriteCharacter)

var sometimesFavoriteCharacter = "Sven"

favoriteCharacter(character: sometimesFavoriteCharacter)

sometimesFavoriteCharacter = "papa troll"
...
func numberOfProblems(number: Int) {
    "I got \(number) problems but Swift ain't one"
}
 ...
 */
func favoriteBandRank(band: String, rank: Int) {
    print("My #\(rank) favorite band is \(band).")
}


favoriteBandRank(band: "The Band", rank: 1)
...
infinityAndBeyond(characterName: "Woody")
