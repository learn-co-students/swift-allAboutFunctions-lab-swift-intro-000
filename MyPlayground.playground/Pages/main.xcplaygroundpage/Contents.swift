 ...
 */
func myFavoriteCharacter(character: String) {
    print("My favorite character is \(character).")
}

var favoriteCharacter = "Jon Snow"
myFavoriteCharacter(character: favoriteCharacter)
 ...
 */
let callOne = frozenAgain()
var callTwo = frozenAgain()
...
let howManyProblems = 99

numberOfProblems(number: howManyProblems)
...
let favoriteBand = "Bush"

favoriteBands(band: favoriteBand, number: 1)
...
madLib(name: "Kevin", noun: "run", preposition: "by")
...
var infinity = character(name: "Kevin")
