...
madLib(charName: "Hanuman", noun: "Ram", preposition: "to")
/*: question10
 ...
 */
// write your code here
func charUp(character: String) ->String{
 return "To infinity and beyond,\(character.uppercased())"
}
charUp(character: "hanuman")
