 ...
 */
let hero = "Tor"
favoriteChar(char: hero)

var superhero = "Tor"
favoriteChar(char: superhero)
...
favoriteBand(bandName: "me", number: 1)
...
madLib(charName: "Griffin", noun: "water", preposition: "over")
 ...
 */
func upper(charName: String) {
    print("To infinity and beyond \((charName.uppercased()))")
}
