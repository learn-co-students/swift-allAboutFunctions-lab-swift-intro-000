...
func bankRank(band: String, rank: Int){
...
func buzz(character: String){
    print("To infinity and beyond, \(character.uppercased())!")
}

let character = "Woody"
buzz(character: character)
