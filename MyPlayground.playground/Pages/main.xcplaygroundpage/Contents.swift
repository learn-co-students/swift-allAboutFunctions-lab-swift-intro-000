 ...
 */
favoriteCharacter(character: "Hayabusa")
 ...
 */
func tagLine(characterName: String) -> String {
    let characterNameUppercase = characterName.uppercased()
    return "To infinity and beyond, \(characterNameUppercase)!"
}

tagLine(characterName: "Buzz Lightyear")
