 ...
 */
let mostFavorite = "Sirius Black"


favCharacter(name: mostFavorite)

var kindaFav = "Hermione Granger"

favCharacter(name: kindaFav)

var kindaFav2 = "Severus Snape"

favCharacter(name: kindaFav2)

//the console prints whatever I change the name to


/*: question5
 ### 5. Write a function that takes an integer as an argument and prints the string "I got <number> problems but Swift ain't one" to the console.
 */
func swiftProblems(number: Int) {
    print("I got \(number) problems but Swift ain't one!")
}

let number = 99

swiftProblems(number: number)
/*: question6
...
favBand(name: name, number: number2)
...
var charName = "Dumbledore"

madLib(noun: noun, preposition: preposition, charName: charName)

/*: question10
 ### 10. Create a function that takes no arguments and returns the string "Buzz Lightyear to the rescue!"
 */
func BuzzStatement() -> String {
