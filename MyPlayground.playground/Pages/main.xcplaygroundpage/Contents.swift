...
// I see that it prints the same sentence with the variable changed
 ...
 */
// write your code here
func favs(num: Int, band: String) {
    print("My # \(num) favorite band is \(band).")
}

favs(num: 1, band: "Linkin Park")
...
madLib(noun: "tree", preposition: "of", charName: "Eliza")
