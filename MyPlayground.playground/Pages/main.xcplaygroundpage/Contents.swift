...
let constantName = "Superman"

favoriteCharacter(name: constantName)

var variableName = "Batman"

favoriteCharacter(name: variableName)
...
favoriteBand(name: "Snarky Puppy", number: 1)
...
madLib(characterName: "Johnny Boy", noun: "subway", preposition: "ride")
...
func buzzFunction(characterName:String) -> String {
