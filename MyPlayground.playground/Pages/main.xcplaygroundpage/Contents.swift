 ...
 */
// write your code here
func favCharac(name: String) {
    print("My favorite character is \(name).")
}

favCharac(name: "Rapunzel")
 ...
 */
// write your code here
func numberSix(band: String, num: Int) {
    print("My #\(num) favorite band is \(band).")
}

numberSix(band: "BTS", num: 1)
...
MadLibs(char: "Moana", noun: "Sea", prep: "on")
