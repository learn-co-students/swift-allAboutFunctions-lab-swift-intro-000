...
favoriteCharacter(character: "Harry Potter")
...
favoriteBand(band: "Imagine Dragons", number: 1)
...
madLib(name: "Jack", noun: "noun", preposition: "preposition")
 ...
 */
func fly(character:String) -> String {
    return "To infinity and beyond, \(character.uppercased())!"
}

print(fly(character:"Bilbo Baggins"))
