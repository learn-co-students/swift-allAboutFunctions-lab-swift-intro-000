...
var anotherCharacter = "Paul"
favCharacter(name: anotherCharacter)
anotherCharacter = "SpongeBob"
favCharacter(name: anotherCharacter)
...
madLibs(name: "Dave", noun: "town", prep: "drink beers")
...
func buzzAgain (name: String) -> String {
    let buzz = "To infinity and beyond, \(name)"
    return buzz
}
