 ...
 */
let _favCharacter = "Elsa"
favCharacter(character: _favCharacter)
//_favCharacter = "Anna"
//favCharacter(character: _favCharacter)



// error telling me that my variable is a constant and needs to be var if I wnat to change it
...
// had to add bandName and position to the call of badFavoriteBand
...
// the argument in the func had positio to take in a String rather than an Int
...
madLib(characterName: "Olof", noun: "New York", preposition: "Love")
