 ...
 */
func numberOfProblem(_ number: Int){
 ...
 */
func favouriteBand(nameOfBand: String, number: Int){
    print("My #\(number) favorite band is \(nameOfBand).")
}
favouriteBand(nameOfBand: "blah", number: 4)
...
madLib(characterName: "jhkj", noun: "jhgjh", preposition: "to")
 ...
 */
func charactersName(charactersName: String) -> String{
    return "To infinity and beyond, \(charactersName.uppercased())!"
}

print(charactersName(charactersName: "David"))
