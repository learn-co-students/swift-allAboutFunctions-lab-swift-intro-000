 ...
 */
let characterName = "SpongeBob"
character(name: characterName)
var favoriteCharacter = "Micky"
character(name: favoriteCharacter)
favoriteCharacter = "Minnie"
character(name: favoriteCharacter)
...
favoriteBand(name: "Cool", number: 1)
...
madLib(name: "Icey2", noun: "Ice", preposition: 2 )
...
characterName(name: character.uppercased())
