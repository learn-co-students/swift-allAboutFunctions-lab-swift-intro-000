 ...
 */
// write your code here
func f1(_ band: String, _ num: Int) {
 ...
 */
// write your code here
func madLibs(_ name: String, _ noun: String, _ preposition: String) {
print("To \(noun) and \(preposition), \(name)!")
}

madLibs("Alex", "beat", "loudly" )
