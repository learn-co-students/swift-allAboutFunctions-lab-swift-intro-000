 ...
 */
func myFavouriteCharacter (_ characterName: String) {
 ...
 */
let character1 = "buzz"
myFavouriteCharacter(character1)

var character2 = "hulk"
myFavouriteCharacter(character2)
 ...
 */
func myFavouriteBand(_ number: Int, _ band: String) {
    print("My #\(number) favorite band is \(band).")
    
}

myFavouriteBand(1, "U2")
...
madLib(name: "quentin", noun: "cat", preposition: "me")
 ...
 */
func superTagline(name: String) -> String {
    return "To infinity and beyond, \(name)!"
}// write your code here

var myTagline = superTagline(name: "Buzz")
print(myTagline)
