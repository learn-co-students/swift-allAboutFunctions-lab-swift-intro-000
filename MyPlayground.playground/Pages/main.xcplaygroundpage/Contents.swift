 ...
 */
// write your code here
let myName = "Trần Quang Hùng"
favorite(name: myName)
myName = "TQH"
favorite(name: myName)
// See errors.
 ...
 */
// write your code here
func yup(band: String, number: Int){
    print("My #\(number) favorite band is \(band).")
}

yup(band: "TQH", number: 22)
...
alsoBadFavoriteBand(bandName: "Blink-182", position: "TQH")
...
madLib(name: "TQH", noun: "H", preposition: "ABCXYZ")
