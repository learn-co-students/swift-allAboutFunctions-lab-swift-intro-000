 ...
 */
// write your code here
let theDude = "Big Lebowski"
var character = "Donnie"
favoriteCharacter(name: theDude)
favoriteCharacter(name: character)
character = "Bunnie Lebowski"
favoriteCharacter(name: character)
...
bandRanking(number: 1, band: "The Beatles")
 ...
 */
// write your code here
func characterLib(name: String)-> String{
    return "To infinity and beyond, \(name)!"
}
characterLib(name: "Woody")
