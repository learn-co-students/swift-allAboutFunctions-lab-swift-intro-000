 ...
 */
func tortall (characterName: String){
    print ("Ny favourite character is \(characterName)")
}
 ...
 */
let secondFave = "Veridane"
tortall(secondFave)

//var theyreCoolTooForDudes = "Numair"
var theyreCoolTooForDudes = "Nawat"
tortall(theyreCoolTooForDudes)
 ...
 */
func music (number: Int, band: String){
...
madLib("school", preposition: "on", characterName: "Doctor WHo")
 ...
 */
func toyStoryRedo (characterName: String) -> String{
