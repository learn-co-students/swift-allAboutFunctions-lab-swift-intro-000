 ...
 */
func third(name: String, num: Int) {
    print("My #\(num) favorite band is \(name).")
}

third(name: "Fort Minor", num: 2)
...
madLib(name: "Fonkey", noun: "school", prepo: "beyond")
 ...
 */
func sixth(name: String) -> String {
    return "To infinity and beyond, \(name)!"
}

print(sixth(name: "Buzz"))
