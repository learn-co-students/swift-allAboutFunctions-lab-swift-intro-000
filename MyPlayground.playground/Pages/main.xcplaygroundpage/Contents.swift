...
favoriteBand(name: "Maroon5", number: 5)
...
madLib(characterName: "Nancy", noun: "person", preposition: "on")
 ...
 */
func buzzLightYear2(character: String) -> String {
   return "To infinity and beyond, \(character.uppercased())!"
   
}

print(buzzLightYear2(character: "Woody"))
