 ...
 */
func music2(bandName: String, number: Int) {
...
madLib(name: "Jon", noun: "Boat", prepo: "under")
 ...
 */
func phrase2(name: String) -> String {
    return "To Infinity and beyond \(name.uppercased())!"
}

print(phrase2(name: "Jon"))
