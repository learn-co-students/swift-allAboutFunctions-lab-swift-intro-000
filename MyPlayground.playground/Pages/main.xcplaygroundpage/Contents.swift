...
favBand(name: "Nickelback", num: 994321)
...
madLib(charName: "Homer Simpson", noun: "refrigerator", prep: "behind")
 ...
 */
func inf(charName:String) -> String {
    return "To infinity and beyond, \(charName.uppercased())!"
}

print(inf(charName: "Woody"))
