 ...
 */
// write your code here
func problems(numberOf: Int) {
   print("I got \(numberOf) problems but Swift ain't one!")
}

problems(numberOf: 99)
...
favoriteBand(band: "DMB", position: 1)
...
madLib(characterName: "Yoda", noun: "light saber", preposition: "below")
