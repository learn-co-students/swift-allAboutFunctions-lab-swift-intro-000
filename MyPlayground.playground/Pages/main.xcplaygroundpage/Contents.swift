...
favoriteCharacter(characterName: myFave)
...
favoriteCharacter(characterName: theirFave)
...
favoriteBand(band: "The Rolling Stones", number: 1)
...
madLib(characterName: character, noun: place, preposition: prep)
 ...
 */
let cartoonCharacter = "Woody"



func buzzQuote(characterName: String)-> String{
    characterName.uppercased()
    return "To infinity and beyond, \(characterName)!"
    
}

print(buzzQuote(characterName: cartoonCharacter))
