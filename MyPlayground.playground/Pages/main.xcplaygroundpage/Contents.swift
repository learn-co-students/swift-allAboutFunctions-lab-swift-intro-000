...
func favBand (name: String, number: Int) {
    print("My \(number)th favorite band is \(name) ")
}

favBand(name: "Green Day", number: 5)
...
madLib(name: "Danny", noun: "house", preposition: "on")
...
func infinity(name: String) -> String {
    return "To infintity and beyond \(name.uppercased())!"
}
