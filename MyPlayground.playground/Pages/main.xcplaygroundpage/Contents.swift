 ...
 */
let characterCons = "Hilda"
var characterVar = "Leela"

character(name: characterCons)
 ...
 */
func bandRank(name:String, at rank:Int) {
    
    print("My #\(rank) favourite band is \(name)")
}

bandRank(name: "Hanson", at: 3)
 ...
 */
func whyThisAgain() -> Int {

    return 29
}

let numCon = whyThisAgain()
