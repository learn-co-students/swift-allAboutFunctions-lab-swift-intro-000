...
favBand(band: "All That Remains", number: 1)
...
madLib(charName: "Taylor", noun: "Cambridge", preposition: "beyond")
 ...
 */
// write your code here
func buzzQuote(char: String) -> String {
    return("To infinity and beyond, \(char)!")
}

print(buzzQuote(char: "Woody"))
